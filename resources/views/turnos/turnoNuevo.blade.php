...
<form method='POST' id="formDetalles" name="detalles" action="{{route('turnos_store')}}" class="mr-1">
    @csrf
    <div class="row">
        <div class="col">
    ...
    <div class="row">
        <div class="col">
            <input type="text" id='textDNI' name="dni_paciente" class="form-control">
        </div>
        <div class="col">
            <input type="datetime-local" id='textFecha' name="fecha" class="form-control">
        </div>
        <div class="col">
    ...
    <div class="row">
        <textarea id="textDetalles" name="detalles" cols="80" rows="5"></textarea>
    </div>
    <div>
